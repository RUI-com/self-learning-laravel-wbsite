...
<body class="bg-[#F2F6F9] flex items-center justify-center min-h-screen relative">
    ...
    <div class="absolute top-[-60px] left-1/2 transform -translate-x-1/2 z-10">
        <img src="{{ asset('storage/images/iPhone 15 Mockup Close Up Poster Freepik.png') }}" alt="iPhone 15 Mockup" class="mx-auto w-64">
    </div>
    ...
    <div class="bg-white p-10 rounded-xl shadow-lg w-full max-w-sm text-center relative z-10">
        ...
        <!-- الأزرار -->
        <a href="{{ route('login') }}" class="block bg-[#E691BD] text-white font-semibold py-2 px-4 rounded mb-4">تسجيل الدخول</a>
        <a href="{{ route('register') }}" class="block bg-[#F4F4F4] hover:bg-[#B6CDEA] text-gray-800 font-semibold py-2 px-4 rounded">إنشاء حساب</a>
    </div>
