...
<head>
    ...
    <title>تطبيقي - الملف الشخصي</title>
   ...
   <div class="flex justify-center items-center">
        <nav class="bg-white shadow-md fixed bottom-0  z-10 flex  py-2 px-6 rounded-xl  max-w-96">
            <div class="flex space-x-8 w-full max-w-96 justify-center">
               ...
               <span class="text-xs">الرئيسية</span>
                ...
                <a href="/profile" class="bg-gradient-to-r from-blue-500 to-blue-700 text-white text-center flex flex-col items-center p-2 rounded-md">
    ...
    <div class="flex justify-center items-center h-[80vh]">
        <div class="text-center p-4 bg-white shadow-lg rounded-lg">
            <h2 class="text-2xl font-semibold text-gray-800">الملف الشخصي</h2>
            <?php if(auth()->guard()->check()): ?>
                <!-- زر تسجيل الخروج -->
                <form method="POST" action="<?php echo e(route('logout')); ?>" class="mt-4">
                    <?php echo csrf_field(); ?>
                    <button type="submit" class="bg-red-600 text-white py-2 px-4 rounded-full hover:bg-red-700">تسجيل الخروج</button>
                </form>
            <?php else: ?>
                <!-- رابط تسجيل الدخول -->
                <a href="<?php echo e(route('login')); ?>" class="text-blue-600 hover:underline font-semibold mt-4 block">
                    تسجيل الدخول
                </a>
            <?php endif; ?>
        </div>
...
<?php /**PATH E:\laravel\self-learning\resources\views\screen\profile.blade.php ENDPATH**/ ?>