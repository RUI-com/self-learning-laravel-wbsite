...
<body class="antialiased bg-gray-100">
    ...
    <div class="flex justify-center items-center">
        <nav class="bg-white shadow-md fixed bottom-0  z-10 flex  py-2 px-6 rounded-xl  max-w-96">
            <div class="flex space-x-8 w-full max-w-96 justify-center">
                ...
                <a href="/search" class="bg-gradient-to-r from-blue-500 to-blue-700 text-white text-center flex flex-col items-center p-2 rounded-md">
                <i class="fi fi-sr-square-terminal"></i>
    ...
    <!-- صفحة البحث -->
    <div class="flex justify-center items-center h-[80vh] mt-16">
        <h1 class="text-3xl font-bold text-gray-700">بحث المستخدمين أو العناصر</h1>
    </div>

</body>
</html>
<?php /**PATH E:\laravel\self-learning\resources\views\screen\search.blade.php ENDPATH**/ ?>