...
<body class="antialiased bg-gray-100">
   ...
   <div class="fixed top-0 left-0 right-0 bg-white shadow-md z-10">
        <nav class="flex justify-between items-center p-4">
            ...
            <img src="<?php echo e(asset('storage/images/world-self.png')); ?>" alt="Logo" class="mx-auto h-10 ">
            </div>
        ...
        <?php $__currentLoopData = $posts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $post): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="bg-white p-6 rounded-lg shadow-lg mb-6 max-w-4xl mx-auto">
                ...
                <div class="flex items-center mb-4">
                    <div class="w-12 h-12 rounded-full bg-gray-300 overflow-hidden">
                        ...
                        <?php if($post->user->profile_image): ?>
                            <img src="<?php echo e(asset('storage/'.$post->user->profile_image)); ?>" alt="User Image" class="w-full h-full object-cover">
                        <?php else: ?>
                            <div class="w-full h-full bg-gray-400"></div>
                        <?php endif; ?>
                    </div>
                    <h2 class="ml-4 font-semibold text-xl text-gray-900"><?php echo e($post->user->name); ?></h2>
                </div>
                ...
                <?php if($post->media_url): ?>
                    <img src="<?php echo e(asset('storage/'.$post->media_url)); ?>" alt="Post Media" class="w-full h-auto rounded-lg shadow-md">
                <?php endif; ?>
                 <!-- عنوان البوست -->
                 <h3 class="text-2xl font-bold text-gray-900 mb-3"><?php echo e($post->title); ?></h3>

<!-- وصف البوست -->
<p class="text-gray-700 text-base mb-4"><?php echo e($post->description); ?></p>

                <!-- خيارات مثل التعليقات أو الإعجابات -->
                <div class="flex justify-between items-center mt-4">
                    <button id="like-button-<?php echo e($post->id); ?>" class="flex items-center bg-blue-500 text-white px-4 py-2 rounded-full text-sm hover:bg-blue-600 transition duration-200">
                        <i id="like-icon-<?php echo e($post->id); ?>" class="fi fi-rr-social-network mr-2"></i>
                        إعجاب
                    </button>
            ...
            <script>
                ...
                document.getElementById('like-button-<?php echo e($post->id); ?>').addEventListener('click', function() {
                    var icon = document.getElementById('like-icon-<?php echo e($post->id); ?>');
...
<?php /**PATH E:\laravel\self-learning\resources\views\screen\home.blade.php ENDPATH**/ ?>