...
<body class="bg-gray-100 flex items-center justify-center h-screen">
    <form method="POST" action="<?php echo e(route('login')); ?>" class="bg-white p-8 rounded-xl shadow-md w-full max-w-sm">
        <?php echo csrf_field(); ?>
         <!-- اللوغو -->
...
<?php /**PATH E:\laravel\self-learning\resources\views\auth\login.blade.php ENDPATH**/ ?>