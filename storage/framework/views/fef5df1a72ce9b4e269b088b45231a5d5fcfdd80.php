...
<body class="bg-gray-100">
    ...
    <div class="max-w-lg mx-auto mt-24 p-6 bg-white shadow-lg rounded-lg">
        ...
        <form action="<?php echo e(route('posts.addpost')); ?>" method="POST" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
            <?php if(Auth::check()): ?>
    <input type="hidden" name="user_id" value="<?php echo e(Auth::id()); ?>" class="mb-4">
<?php else: ?>
...
<?php /**PATH E:\laravel\self-learning\resources\views\posts\addpost.blade.php ENDPATH**/ ?>